...
X856_bn = bn_relations.copy()[(bn_relations['id'].str.contains('pl')) & (bn_relations['typ'] == 'book')].drop(columns='typ').rename(columns={'id':'rekord_id', 856:'856'})
